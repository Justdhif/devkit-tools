...
export declare const savedPipelines: import("drizzle-orm/pg-core").PgTableWithColumns<{
    name: "saved_pipelines";
    schema: undefined;
    columns: {
        id: import("drizzle-orm/pg-core").PgColumn<{
            name: "id";
            tableName: "saved_pipelines";
            dataType: "string";
            columnType: "PgText";
            data: string;
            driverParam: string;
        ...
        initialInput: import("drizzle-orm/pg-core").PgColumn<{
            name: "initial_input";
            tableName: "saved_pipelines";
            dataType: "string";
            columnType: "PgText";
